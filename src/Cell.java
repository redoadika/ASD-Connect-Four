...
public class Cell {
   ...
   public void paint(Graphics g, BufferedImage playerImage, BufferedImage computerImage) {
    int x = col * SIZE + PADDING;
    int y = row * SIZE + PADDING;

    if (content == Seed.CROSS) {
        g.drawImage(playerImage, x, y, SEED_SIZE, SEED_SIZE, null);
    } else if (content == Seed.NOUGHT) {
        g.drawImage(computerImage, x, y, SEED_SIZE, SEED_SIZE, null);
    }
   }
}
